INSERT INTO "user" (username, name, password, role) values ('mhernandez', 'menganito hernández', '$2a$10$HpsuaJK15e6TetIBjYg2f.p/NUeBcNyGaKK4oaNMNMh0AFux8ef2m', 'ADMINISTRATOR');
INSERT INTO "user" (username, name, password, role) values ('lmarquez', 'luis márquez', '$2a$10$XpVU9FzlRXyYvUfFRQW9o./dq2GKTFrkCQ/OwY1cfjXpIJm/7JEz6', 'CUSTOMER');
